...
public class CardSliderLayoutManager extends RecyclerView.LayoutManager
    ...
    public interface ViewUpdater {
         ...
         */
        void onLayoutManagerInitialized(@NonNull com.example.blogmy.cards.CardSliderLayoutManager lm);
    ...
    private static class SavedState implements Parcelable {
        ...
        public static final Creator<SavedState> CREATOR = new Creator<com.example.blogmy.cards.CardSliderLayoutManager.SavedState>() {
            @Override
            public com.example.blogmy.cards.CardSliderLayoutManager.SavedState createFromParcel(Parcel parcel) {
                return new com.example.blogmy.cards.CardSliderLayoutManager.SavedState(parcel);
            }

            @Override
            public com.example.blogmy.cards.CardSliderLayoutManager.SavedState[] newArray(int size) {
                return new com.example.blogmy.cards.CardSliderLayoutManager.SavedState[size];
            }
        };
    ...
    private ViewUpdater loadViewUpdater(Context context, String className, AttributeSet attrs) {
        ...
        if (className.charAt(0) == '.') {
            ...
            fullClassName = com.example.blogmy.cards.CardSliderLayoutManager.class.getPackage().getName() + '.' + className;
        }
